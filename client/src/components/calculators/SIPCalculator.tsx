    ...
    <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <Label className="text-slate-600 font-semibold uppercase tracking-wider text-xs">Monthly Investment (₹)</Label>
              <span className="text-slate-900 font-extrabold text-xl">{formatCurrency(monthlyInvestment)}</span>
            </div>
            <input 
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <Label className="text-slate-600 font-semibold uppercase tracking-wider text-xs">Annual Step-up (%)</Label>
              <span className="text-slate-900 font-extrabold text-xl">{stepUp}%</span>
            </div>
            <input 
            ...
            />
            <p className="text-xs font-medium text-slate-500">Increase SIP amount every year to beat inflation.</p>
          </div>
        </div>
      </div>
      ...
      <div className="lg:col-span-2 space-y-6">
        ...
        <div className="h-[300px] bg-white rounded-2xl p-4 border border-slate-200 shadow-sm">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={result.data} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
              ...
              />
              <Area type="monotone" dataKey="invested" name="Invested Amount" stroke="#3b82f6" strokeWidth={3} fill="url(#colorInvested)" animationDuration={1500} />
              <Area type="monotone" dataKey="wealth" name="Total Wealth" stroke="#10b981" strokeWidth={3} fill="url(#colorWealth)" animationDuration={1500} />
            </AreaChart>
          </ResponsiveContainer>
        </div>
        ...
        <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-5 flex gap-4 text-emerald-900 shadow-sm">
          ...
          <div>
            <p className="font-semibold mb-1">The magic of compounding</p>
            <p className="text-sm text-emerald-800 leading-relaxed">
              By year {years}, your money starts working harder than you do. 
